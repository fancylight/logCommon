...
public class LoggingWSServer {
    ...
    private String applicationName="dreamsoft";
    ...
    public void onOpen(Session session) {
        ...
        //获取日志信息
        new Thread(() -> {
            CommonLogUtil.outNormalInfo("LoggingWebSocketServer 任务开始");
            boolean first = true;
            ...
            CommonLogUtil.outNormalInfo("LoggingWebSocketServer 任务结束");
        }).start();
    }
